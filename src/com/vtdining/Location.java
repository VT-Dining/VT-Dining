...
public class Location implements Serializable{
	...
	for(String s:hours) {
	    ...
	    int h1=Integer.parseInt(hour1)*60+(time1.contains("pm")?12*60:0);
	    int h2=Integer.parseInt(hour2)*60+(time2.contains("pm")?12*60:0);
	    if(h1==720)
		h1=0;
	    if(h2==720)
		h2=0;
    ...
    public Vector<String> getHours(){return hours;}
